...
###multilayer plotting
# quickplot(ro3006, ro3035, ro3003, 0, 4, 0)
# quickplot(ro3006, ro3035, rod5880, 4, 2, 4)
# quickplot(ro3006, ro3035, pmr15, 4, 4, 1)
# quickplot(ro3006, ro3035, zitex, 4, 4, 4)
# quickplot(ro3006, ro3003, rod5880, 4, 2, 4)
# quickplot(ro3006, ro3003, pmr15, 4, 4, 1)
quickplot(ro3006, ro3003, zitex, 2, 1, 2)
# quickplot(ro3006, rod5880, pmr15, 4, 4, 0)
# quickplot(ro3006, rod5880, zitex, 4, 4, 1)
# quickplot(ro3006, pmr15, zitex, 4, 1, 0)
# quickplot(ro3035, ro3003, rod5880, 4, 2, 2)
# quickplot(ro3035, ro3003, pmr15, 4, 4, 0)
# quickplot(ro3035, ro3003, zitex, 4, 3, 2)
# quickplot(ro3035, rod5880, pmr15, 4, 3, 0)
# quickplot(ro3035, rod5880, zitex, 4, 3, 0)
# quickplot(ro3035, pmr15, zitex, 4, 0, 3)
# quickplot(ro3003, rod5880, pmr15, 4, 3, 0)
# quickplot(ro3003, rod5880, zitex, 4, 3, 0)
# quickplot(ro3003, pmr15, zitex, 4, 0, 3)
# quickplot(rod5880, pmr15, zitex, 4, 0, 1)
...
# multimean(ro3006, ro3035, rod5880, 4)
# multimean(ro3006, ro3035, pmr15, 4)
# multimean(ro3006, ro3035, zitex, 4)
# multimean(ro3006, ro3003, rod5880, 4)
...
# multimean(ro3035, ro3003, rod5880, 4)
# multimean(ro3035, ro3003, pmr15, 4)
# multimean(ro3035, ro3003, zitex, 4)
# multimean(ro3035, rod5880, pmr15, 4)
# multimean(ro3035, rod5880, zitex, 4)
# multimean(ro3035, pmr15, zitex, 4)
# multimean(ro3003, rod5880, pmr15, 4)
# multimean(ro3003, rod5880, zitex, 4)
...
# all_layers_mean(ro3006, ro3035, ro3003, 4)
# plt.show()
# all_layers_mean(ro3006, ro3035, rod5880, 4)
# plt.show()
# all_layers_mean(ro3006, ro3035, pmr15, 4)
# plt.show()
# all_layers_mean(ro3006, ro3035, zitex, 4)
# plt.show()
# all_layers_mean(ro3006, ro3003, rod5880, 4)
# plt.show()
# all_layers_mean(ro3006, ro3003, pmr15, 4)
# plt.show()
# all_layers_mean(ro3006, ro3003, zitex, 4)
# plt.show()
# all_layers_mean(ro3006, rod5880, pmr15, 4)
# plt.show()
# all_layers_mean(ro3006, rod5880, zitex, 4)
# plt.show()
# all_layers_mean(ro3006, pmr15, zitex, 4)
# plt.show()
# all_layers_mean(ro3035, ro3003, rod5880, 4)
# plt.show()
# all_layers_mean(ro3035, ro3003, pmr15, 4)
# plt.show()
# all_layers_mean(ro3035, ro3003, zitex, 4)
# plt.show()
# all_layers_mean(ro3035, rod5880, pmr15, 4)
# plt.show()
# all_layers_mean(ro3035, rod5880, zitex, 4)
# plt.show()
# all_layers_mean(ro3035, pmr15, zitex, 4)
# plt.show()
# all_layers_mean(ro3003, rod5880, pmr15, 4)
# plt.show()
# all_layers_mean(ro3003, rod5880, zitex, 4)
# plt.show()
# all_layers_mean(ro3003, pmr15, zitex, 4)
# plt.show()
# all_layers_mean(rod5880, pmr15, zitex, 4)
# plt.show()
